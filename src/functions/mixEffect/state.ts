...
// 		{ id: ActionId.FtbAfv, type: ReqType.Get },
...
// 			}
// 			state.selectTransitionStyle.style = value
// 			break
// 		}
// 		case ActionId.TransitionDipFillSource:
// 			state.selectDipSource=Number(data.value![0]);
// 			break;
// 		case ActionId.TransitionDipFillSourceList:
// 			var str = String(data.value)
// 			state.dipSources =  str ? str.split(',').map(Number) : []
// 			break;
// 		case ActionId.TransitionDipRate:
// 			state.selectTransitionStyle.diprate = Number(data.value![0])
// 			break;
// 		case ActionId.TransitionWipeRate:
// 			state.selectTransitionStyle.wiperate = Number(data.value![0])
// 			break;
// 		case ActionId.TransitionMixRate:
// 			state.selectTransitionStyle.mixrate = Number(data.value![0])
// 			break;
