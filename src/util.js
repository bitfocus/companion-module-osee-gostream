...
exports.IsCrcOK = exports.UpackDatas = exports.Bytes2ToInt = exports.Bytes4ToInt = exports.GetModbusCrc16 = exports.IntTo2Bytes = exports.IntTo4Bytes = exports.PackData = exports.ProType = exports.HEAD2 = exports.HEAD1 = exports.compareNumber = exports.NumberComparitor = void 0;
...
})(NumberComparitor = exports.NumberComparitor || (exports.NumberComparitor = {}));
...
function PackData(Datas) {
    ...
    if (Datas != undefined)
        Datas.copy(datas, 5, 0, Datas.length);
...
exports.IntTo4Bytes = IntTo4Bytes;
...
exports.IntTo2Bytes = IntTo2Bytes;
function GetModbusCrc16(bytes) {
    let crcRegister_H = 0xFF, crcRegister_L = 0xFF; // 预置一个值为 0xFFFF 的 16 位寄存器
    let polynomialCode_H = 0xA0, polynomialCode_L = 0x01; // 多项式码 0xA001
...
exports.GetModbusCrc16 = GetModbusCrc16;
...
exports.Bytes4ToInt = Bytes4ToInt;
function Bytes2ToInt(bs, lowByteFirst) {
    if (lowByteFirst) {
        if (bs[1] === 0xFF)
            return Bytes4ToInt(new Array()[bs[0], 0xFF, 0xFF, 0xFF], lowByteFirst);
    }
    else if (bs[0] === 0xFF) {
...
exports.Bytes2ToInt = Bytes2ToInt;
function UpackDatas(resp) {
    ...
    if (resp_len != (resp.length - 5)) {
        console.log("Recv Error:" + resp.toString('hex').match(/.{1,2}/g)?.join(' '));
...
exports.IsCrcOK = IsCrcOK;
//# sourceMappingURL=util.js.map

//# sourceURL=webpack://osee-gostreamdeck/./dist/util.js?
